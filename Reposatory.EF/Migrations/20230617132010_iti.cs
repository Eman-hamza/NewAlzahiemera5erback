        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    middleDegree = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicenName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Helpers_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    diseaselevel = table.Column<int>(type: "int", nullable: false),
                    DeseasDiscription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HelperProposals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HelperProposals_AspNetUsers_userId",
                        column: x => x.userId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_HelperProposals_HelpRequests_HelpRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HelperProposals_HelpRequestId",
                table: "HelperProposals",
                column: "HelpRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_HelperProposals_userId",
                table: "HelperProposals",
                column: "userId");
